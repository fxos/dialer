      ...
      function s(o, u) {
        ...
        (function (define) {
          define(function (require, exports, module) {
            ...
            if (!isLoaded()) {
              load(base + "gaia-icons/gaia-icons.css");
            }
        ...
        ;(function (define) {
          "use strict";define(function (require, exports, module) {
            ...
            var GaiaHeaderFontFit = {
               ...
               */
              _HEADER_SIZES: [16, 17, 18, 19, 20, 21, 22, 23, 24],
              ...
              _handleTextChanges: function (mutations) {
                ...
                for (var _iterator = targets[Symbol.iterator](), _step; !(_step = _iterator.next()).done;) {
              ...
              _autoResizeElement: function (heading, styleOptions) {
                var contentWidth = styleOptions.contentWidth || this._getContentWidth(heading);

                var fontFamily = styleOptions.fontFamily || getComputedStyle(heading).fontFamily;

                var text = heading.textContent.replace(/\s+/g, " ").trim();

                var info = this._getMaxFontSizeInfo(text, this._HEADER_SIZES, fontFamily, contentWidth);
              ...
              _centerTextToScreen: function (heading, styleOptions) {
                ...
                var sideSpaceRight = this._getWindowWidth() - sideSpaceLeft - styleOptions.contentWidth - styleOptions.paddingRight - styleOptions.paddingLeft;
